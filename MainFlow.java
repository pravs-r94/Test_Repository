    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 2; i++)
        {
            ...
            if (login.equalsIgnoreCase(CUSTOMER)) {
                ...
                ArrayList<Customer> mockPortfolios = portfolioHelper.mockData();
               Date date = new Date();
               SimpleDateFormat purchaseDate = new SimpleDateFormat("dd/MM/yyyy");
                ...
                for (int j = 0; j < 10; j++)
                {
                    for (Customer mockPortfolio : mockPortfolios)
                    {
                        if (mockPortfolio.getCustomerName().equals(cName))
                        {
                            ...
                            if (action == 1)
                            {
                                mockPortfolio = portfolioHelper.buyStocks(stocks1, cName, purchaseDate, mockPortfolio);
                            }
                            if (action == 2) {
                                portfolioHelper.viewPortfolio(mockPortfolio);
                            }
                            if (action == 4) {
                                break;
                            }
                    ...
                    if (cName != "Neethu" || cName != "Gouthu")
                    {
                        ...
                        if (action2 == 1) {
                            ...
                            customer = portfolioHelper.buyStocks(stocks1, cName, purchaseDate, customer);
                        }

                        if (action2 == 2) {
                            portfolioHelper.viewPortfolio(customer);
                        }
                           /* if(action==3)
                            {
